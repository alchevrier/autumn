...
class NetworkConcurrencyBudgetProcessorSimulatorTest {
    ...
    fun `compiler statically injects budget and strictly bounds slot manager array`() {
        ...
        // val slotManager = ...
        val annotation = NetworkConcurrencyBudget(maxInFlightRequests = 2)
        ...
        assertEquals(2, staticallyInjectedBudget)
        ...
        assertEquals(-1, slotManager.claimSlot(), "Third request must instantly circuit break (-1)")
